...
function UpdateArt(state)
	...
	if (state == STATE_SLEEPING) then
		SLEEPING_ART.visibility = Visibility.FORCE_ON
		
	elseif (state == STATE_ENGAGING) then
		ENGAGING_ART.visibility = Visibility.FORCE_ON
		
	elseif (state == STATE_ATTACK_CAST or state == STATE_ATTACK_RECOVERY) then
		ATTACKING_ART.visibility = Visibility.FORCE_ON
		
	elseif (state == STATE_PATROLLING or state == STATE_LOOKING_AROUND) then
		PATROLLING_ART.visibility = Visibility.FORCE_ON
		
	else
		DEAD_ART.visibility = Visibility.FORCE_ON
	end
end
